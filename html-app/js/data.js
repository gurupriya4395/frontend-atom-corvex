...
export const EVENTS = [
  ...
  },
  {
    ...
    category: 'environmental',
    domain: 'Natural Disasters',
    title: 'Flash flooding 3 km from Bengaluru office after cloudburst',
    summary:
      'BBMP reports knee-deep water on the Outer Ring Road corridor. Last-mile access to the Bengaluru office is slowing. Medium meteorological risk, high exposure on a critical site — this is an alert.',
    place: 'Bengaluru, Karnataka, India',
    flag: 'IN',
    coords: [77.622, 12.9716],
    severity: 'medium',
    source: 'The Times of India',
    sourceUrl: 'https://timesofindia.indiatimes.com/india',
    publishedAt: hoursAgo(0.2),
    eventAt: hoursAgo(0.25),
    why: '3 km from Bengaluru Office · medium risk × high exposure → high-priority alert.',
    updates: [
      { at: hoursAgo(0.25), text: 'ORR ponding · office last-mile slowing' },
      { at: hoursAgo(0.12), text: 'Staff advised to delay campus arrival' },
    ],
  },
  {
    id: 'ev-sec-ggm',
  ...
  },
  {
    ...
    category: 'environmental',
    domain: 'Natural Disasters',
    title: 'M6.8 earthquake off Tohoku; tsunami watch cancelled',
    summary:
      'JMA reports a strong offshore event. Regional rail paused. No ATOM customer assets in radius — high risk, zero exposure. Logged as an event, not an alert.',
    ...
    why: 'Risk high · Exposure none · not an alert. Nobody is paged without an ATOM footprint.',
  },
  {
    id: 'ev-unrest-ist',
    kind: 'protest',
